...
public abstract class CustomCustomsBase implements Puzzle<String> {
  protected final String INPUT = "clvxybjp\n" +
      "kripatlzy\n" +
      "\n" +
      "yrn\n" +
      "labirzd\n" +
  ...
  public static void main(String[] args) {
    new CustomCustomsOne().resolve();
    new CustomCustomsTwo().resolve();
  }

  protected CustomCustomsBase() {
    this.INPUT_PROCESSED = Strings.splitAndJoinSections(INPUT);
  }
